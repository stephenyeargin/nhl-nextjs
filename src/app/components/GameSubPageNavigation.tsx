...
const GameSubPageNavigation: React.FC = () => {
  const [audioPlayerUrl, setAudioPlayerUrl] = useState<string | null>(null);
  const [audioPlayerLabel, setAudioPlayerLabel] = useState<string | null>(null);
  const [isAudioPlayerVisible, setAudioPlayerVisible] = useState<boolean>(false);
  const [isAudioPlayerPlaying, setAudioPlayerPlaying] = useState<boolean>(true);
