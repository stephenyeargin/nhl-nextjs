...
describe('PeriodSelector', () => {
  test('renders options including All when includeAll', () => {
    ...
    render(<PeriodSelector periodData={{ number: 3, maxRegulationPeriods: 3 }} activePeriod={0} handlePeriodChange={handle} includeAll />);
  ...
  test('calls handlePeriodChange on selection', () => {
    const handle = jest.fn();
    render(<PeriodSelector periodData={{ number: 2 }} activePeriod={1} handlePeriodChange={handle} />);
