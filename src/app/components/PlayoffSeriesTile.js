...
const TBDLogo = ({ className }) => (<Image src="https://assets.nhle.com/logos/nhl/svg/team-tbd-light.svg" width="1024" height="1024" alt="To Be Determined" className={className || 'w-8 h-8 mr-3'} />);
