...
interface ExternalContent { html?: string; body?: string }
interface ExternalPart { _entityId: string; content: ExternalContent }
interface ContentExternalProps { part: ExternalPart }
