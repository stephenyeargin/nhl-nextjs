...
const LeagueToggle: React.FC<LeagueToggleProps> = ({
  activeLeague = 'nhl',
  handleChangeLeagues,
  activeColor,
}) => {
    ...
    <div>
      <div className="flex space-x-0 text-sm">
        <button
          ...
          style={{
            backgroundColor: activeLeague === 'nhl' ? activeColor : 'inherit',
            color:
              activeLeague === 'nhl' ? formatTextColorByBackgroundColor(activeColor) : 'inherit',
          }}
        ...
        >
          <TeamLogo
            ...
            className="w-5 h-5"
          />
          <div>National Hockey League</div>
        </button>
        <button
          className="flex gap-1 items-center p-2 border rounded-r-md bg-inherit text-black dark:text-white"
          style={{
            backgroundColor: activeLeague === 'other' ? activeColor : 'inherit',
            color:
              activeLeague === 'other' ? formatTextColorByBackgroundColor(activeColor) : 'inherit',
          }}
