        ...
        <div className="border rounded-md sm:mt-5 md:mt-0 md:ml-auto px-3 py-2 bg-slate-100 dark:bg-slate-900 shadow-sm">
          <label htmlFor="standings-date" className="flex items-center gap-2 text-sm">
            ...
            <input
              ...
              max={todayDate}
              className="h-9 min-w-38 rounded border border-slate-400 dark:border-slate-600 px-2 py-1 bg-white text-black scheme-light focus:outline-none focus:ring-2 focus:ring-slate-500"
