...
interface CustomEntityFields {
  brightcoveAccountId?: string;
  brightcoveId?: string;
  description?: string;
  longDescription?: string;
  url?: { url?: string; openInNewTab?: boolean };
  callToAction1Link?: { url?: string; displayText?: string; openInNewTab?: boolean };
  callToAction2Link?: { url?: string; displayText?: string; openInNewTab?: boolean };
  headline?: string;
  biography?: string;
}
...
interface CustomEntityPart {
  ...
  contextualFields?: { layout?: string };
  thumbnail?: Thumbnail;
  entityCode: string;
  title?: string;
}
